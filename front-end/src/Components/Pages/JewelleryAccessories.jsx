...
const JewelleryAccessories = ({ productData }) => {
    ...
    useEffect(() => {
        ...
        setArray(data_jwel.slice(start, end));
    }, [currentPage]);
    ...
    return <>
        ...
        <div style={{ display: "flex", justifyContent: "center", marginTop: "10px" }}>
            ...
            <button style={{ margin: '2%' }} onClick={() => { setCurrentPage(currentPage + 1) }} disabled={currentPage === Math.floor(data_jwel.length / postsPerPage) + 1}  >Next</button>
        </div>
